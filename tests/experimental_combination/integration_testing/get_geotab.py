...
def get_recent_geotab(attenuator_ids, query_interval_minutes, _bigquery_client):
    ...
    return [{'avl_location': i['avl_location'], 'rtdh_message_id': i['rtdh_message_id'], 'rtdh_timestamp': i['rtdh_timestamp'].strftime(ISO_8601_FORMAT_STRING)} for i in get_query_results(query_str, _bigquery_client)]
