...
test_wzdx_creator_expected_road_restriction = {'feed_info': {'update_date': '2021-04-13T00:00:00Z', 'publisher': 'CDOT', 'contact_name': 'Heather Pickering-Hilgers', 'contact_email': 'heather.pickeringhilgers@state.co.us', 'version': '4.0', 'license': 'https://creativecommons.org/publicdomain/zero/1.0/', 'data_sources': [{'data_source_id': 'w', 'organization_name': 'CDOT', 'contact_name': 'Heather Pickering-Hilgers', 'contact_email': 'heather.pickeringhilgers@state.co.us', 'update_date': '2021-04-13T00:00:00Z'}]}, 'type': 'FeatureCollection', 'features': [{'type': 'Feature', 'properties': {'core_details': {
