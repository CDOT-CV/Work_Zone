...
def test_get_chord_length():
    pt1 = [-105.02518638968468, 39.776638166930375]
    pt2 = [-105.02523601055145, 39.771953483109826]
...
def test_generage_compressed_path():
    wzdx = json.loads(open("./tests/data/path_compression_valid_path.json").read())
