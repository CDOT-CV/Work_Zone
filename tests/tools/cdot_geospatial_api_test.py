...
#     assert cdot_geospatial_api.get_routes_list()


def test_get_route_details():
    expected = {'Route': '070A', 'MMin': 0, 'MMax': 449.589}
    assert cdot_geospatial_api.get_route_details('070A') == expected
