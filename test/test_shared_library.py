...
def test_parse_arguments():
    ...
    test_input,test_output=translator_shared_library.parse_arguments(test_argv)
...
#--------------------------------------------------------------------------------unit test for validate_write function--------------------------------------------------------------------------------
def test_validate_wzdx_valid_wzdx_data():
    ...
    validate_write=translator_shared_library.validate_wzdx(valid_wzdx_data,test_schema)
    assert validate_write == True

def test_validate_write_invvalid_wzdx_data():
