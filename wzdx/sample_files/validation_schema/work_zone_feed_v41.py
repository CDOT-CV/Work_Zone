wzdx_v41_schema_string = {
    ...
    "properties": {
        "feed_info": {
            "$id": "https://raw.githubusercontent.com/usdot-jpo-ode/wzdx/main/schemas/4.1/FeedInfo.json",
            "$schema": "http://json-schema.org/draft-07/schema#",
        ...
        "features": {
            ...
            "items": {
                "allOf": [
                    ...
                    {
                        "$id": "https://raw.githubusercontent.com/usdot-jpo-ode/wzdx/main/schemas/4.1/RoadEventFeature.json",
                        "$schema": "http://json-schema.org/draft-07/schema#",
                        ...
                        "properties": {
                            ...
                            "bbox": {
                                "$id": "https://raw.githubusercontent.com/usdot-jpo-ode/wzdx/main/schemas/4.1/BoundingBox.json",
                                "$schema": "http://json-schema.org/draft-07/schema#",
                        ...
                        "definitions": {
                            ...
                            "RoadEventCoreDetails": {
                                ...
                                "properties": {
                                    ...
                                    "direction": {
                                        "$id": "https://raw.githubusercontent.com/usdot-jpo-ode/wzdx/main/schemas/4.1/Direction.json",
                                        "$schema": "http://json-schema.org/draft-07/schema#",
