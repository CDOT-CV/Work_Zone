...
EVENT_TYPE_MAPPING = {
    "Bridge Construction":              ('work_zone', {'type_name': 'below-road-work',            'is_architectural_change': True}),
    "Road Construction":                ('work_zone', {'type_name': 'roadway-creation',           'is_architectural_change': True}),
    "Bridge Maintenance Operations":    ('work_zone', {'type_name': 'below-road-work',            'is_architectural_change': False}),
    "Bridge Repair":                    ('work_zone', {'type_name': 'below-road-work',            'is_architectural_change': False}),
    "Chip Seal Operations":             ('work_zone', {'type_name': 'minor-road-defect-repair',   'is_architectural_change': False}),
    "Concrete Slab Replacement":        ('work_zone', {'type_name': 'surface-work',               'is_architectural_change': False}),
    "Crack Sealing":                    ('work_zone', {'type_name': 'minor-road-defect-repair',   'is_architectural_change': False}),
    "Culvert Maintenance":              ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Electrical or Lighting":           ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Emergency Maintenance":            ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Fiber Optics Installation":        ('work_zone', {'type_name': 'surface-work',               'is_architectural_change': False}),
    "Guardrail":                        ('work_zone', {'type_name': 'barrier-work',               'is_architectural_change': False}),
    "IT or Fiber Optics":               ('work_zone', {'type_name': 'surface-work',               'is_architectural_change': False}),
    "Other":                            ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Paving Operations":                ('work_zone', {'type_name': 'surface-work',               'is_architectural_change': True}),
    "Road Maintenance Operations":      ('work_zone', {'type_name': 'surface-work',               'is_architectural_change': False}),
    "Rock Work":                        ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Sign Work":                        ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Striping Operations":              ('work_zone', {'type_name': 'painting',                   'is_architectural_change': True}),
    "Traffic Sign Installation":        ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Traffic Sign Maintenance":         ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Traffic Signal Installation":      ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Traffic Signal Maintenance":       ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Tunnel Maintenance":               ('work_zone', {'type_name': 'surface-work',               'is_architectural_change': False}),
    "Utility Work":                     ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Utility Installation":             ('work_zone', {'type_name': 'roadside-work',              'is_architectural_change': False}),
    "Wall Maintenance":                 ('work_zone', {'type_name': 'barrier-work',               'is_architectural_change': False}),

    "BAN Message":                      ('restriction', None),
    "Safety Campaign":                  ('restriction', None),
    "Smoke/Control Burn":               ('restriction', None),
    "Other":                            ('restriction', None),
    "Avalanche Control":                ('restriction', None),
    "Closed for the Season":            ('restriction', None),
    "Funeral Procession":               ('restriction', None),
    "Presidential Visit":               ('restriction', None),
    "Race Event":                       ('restriction', None),
    "Local Event":                      ('restriction', None),
    "Military Movement":                ('restriction', None),
    "OS/OW Limit":                      ('restriction', None),
}
...
def create_rtdh_standard_msg(pd):
    ...
    event_type, type_of_work = map_event_type(
